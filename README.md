...
Write a program that will process command line options specified below.  Options must be processed according to their order from right to left.  The same option can occur several times. 
